# Operator Quickstart — Community Quarry and Stone Supply

Shortest path from clone to a verified local dry-run for **ISIC 0810** (`cloud-itonami-isic-0810`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0810.git
cd cloud-itonami-isic-0810
```
...
- Blueprint governor key: `quarry-governor`
- Likely source path: `quarryops.governor.cljc`
